...
public class ClassPathScanningCandidateComponentProvider implements EnvironmentCapable, ResourceLoaderAware {
	...
	protected void registerDefaultFilters() {
		// 添加@Component注解修饰的Filter到includeFilters中
		this.includeFilters.add(new AnnotationTypeFilter(Component.class));
		ClassLoader cl = ClassPathScanningCandidateComponentProvider.class.getClassLoader();
		try {
			// 添加@ManagedBean注解修饰的Filter到includeFilters中
		...
		try {
			// 添加@Named注解修饰的Filter到includeFilters中，这边会抛ClassNotFoundException
			this.includeFilters.add(new AnnotationTypeFilter(
	...
	protected boolean isCandidateComponent(MetadataReader metadataReader) throws IOException {
		...
		// 默认情况下 excludeFilters为空，includeFilters包含：@Component注解的 TypeFilter、@ManagedBean注解的 TypeFilter。
		// 因此，在正常情况下，使用了 @Component（包括被 @Component修饰的 @Controller、@Repository、@Service） 注解的类在这边
		// 会返回 true，表示该类是候选者类。
	}
